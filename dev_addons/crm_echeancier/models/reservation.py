...
class CrmReservation(models.Model):
    ...
    amount_total = fields.Monetary(related='order_id.amount_untaxed', string='Total (HT)', currency_field='currency_id', readonly=True, store=True)
    amount_tva = fields.Monetary(related='order_id.amount_tax', string='Total TVA', currency_field='currency_id', readonly=True)
    total_paiement = fields.Monetary(related='order_id.total_paiement', string='Total paiement', store=True)
