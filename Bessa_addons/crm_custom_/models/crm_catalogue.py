...
class ProductTemplate(models.Model):
    ...
    def fields_view_get(self, view_id=None, view_type=None, toolbar=False, submenu=False):
        ...
        # consu
        if group_caissier or group_commercial or group_adv or group_res_adv or group_res_recouvrement or group_charg_recouvrement or group_assistante_adv or group_res_compta:
