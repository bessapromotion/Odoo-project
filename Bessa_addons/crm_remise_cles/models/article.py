...
class Article(models.Model):
    ...
    manager = fields.Char(related="company_id.contract_represente", string='Manager')
    ...
    def set_values(self):
        ...
        self.address = self.company_id.street + ' ' + self.company_id.city + '-' + self.company_id.state_id.name
        variables = {
