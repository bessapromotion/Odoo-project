...
class CrmEcheancier(models.Model):
    ...
    def fields_view_get(self, view_id=None, view_type=None, toolbar=False, submenu=False):
        ...
        # input 0 edit 0
        if group_charg_recouvrement or group_comptable_stock or group_res_compta or group_res_recouvrement:
...
class OrdrePaiement(models.Model):
    ...
    def fields_view_get(self, view_id=None, view_type=None, toolbar=False, submenu=False):
        ...
        # input 0 edit 0
        if group_res_recouvrement or group_charg_recouvrement or group_comptable_stock or group_res_compta:
        ...
        if group_commercial:
            ...
            res['arch'] = etree.tostring(doc)
        if group_adv or group_res_adv or group_res_commercial:
...
class AccountPaiement(models.Model):
    ...
    def fields_view_get(self, view_id=None, view_type=None, toolbar=False, submenu=False):
        ...
        doc = etree.XML(res['arch'])
        if group_res_recouvrement or group_commercial or group_charg_recouvrement or group_res_commercial or group_adv or group_res_adv or group_comptable_stock or group_res_compta:
