...
class SaleOrder(models.Model):
    ...
    def fields_view_get(self, view_id=None, view_type=None, toolbar=False, submenu=False):
        ...
        # 1 1 1
        if group_commercial or group_res_commercial or group_adv or group_res_adv:
        ...
        # 0 0 0
        if group_caissier or group_charg_recouvrement or group_res_recouvrement or group_assistante_adv or group_comptable_stock or group_res_compta:
...
class CrmAnnulation(models.Model):
    ...
    def fields_view_get(self, view_id=None, view_type=None, toolbar=False, submenu=False):
        ...
        if group_adv or group_res_adv:
            ...
            res['arch'] = etree.tostring(doc)
        if group_res_commercial or group_commercial:
