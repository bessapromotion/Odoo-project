...
class ChargerBienWizard(models.TransientModel):
    ...
    bloc_ids = fields.Many2many('crm.superficie.bloc.wizard', 'crm_superficie_bloc_wizard_crm_bien_wizard_rel', string='Bloc')
...
class ChargerBienLineWizard(models.TransientModel):
    ...
    wiz_id    = fields.Many2one('crm.superficie.charger.bien.wizard', string='Changement de superficie')
