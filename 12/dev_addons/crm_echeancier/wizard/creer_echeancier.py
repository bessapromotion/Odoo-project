...
class CreerEcheancierWizard(models.TransientModel):
    ...
    date = fields.Date(u'Date premiere écheance')  # , required=1)
    number = fields.Integer('Nomber echeance')  # , required=1)
    ...
    first_payment = fields.Float('Premier versement', currency_field='currency_id',
                                 default=lambda self: self._first_paiement())
