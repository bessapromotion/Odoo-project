    ...
    def action_validate(self):
        ...
        def change_label_2(produit):
            ...
            if produit.type_id.name == 'Place de parking':
                return produit.project_id.name + ' Place de parking Bloc ' + (produit.bloc or '') + ' ' + (produit.etage.name or '' ) + ' Lot ' + (produit.num_lot or '') + ' Num '+ (produit.numero or '')
            if produit.type_id.name == 'Cellier':
                return produit.project_id.name + ' Cellier Bloc ' + (produit.bloc or '') + ' ' + (produit.etage.name or '' ) + ' Lot ' + (produit.num_lot or '') + ' Num '+ (produit.numero or '')
            if produit.type_id.name == 'Espace a aménager':
                return produit.project_id.name + ' Espace a aménager Bloc' + (produit.bloc or '') + ' ' + (produit.etage.name or '' ) + ' Lot ' + (produit.num_lot or '') + ' Num '+ (produit.numero or '')
            if produit.type_id.name == 'Local':
                return produit.project_id.name + ' Local Bloc' + (produit.bloc or '') + ' ' + (produit.etage.name or '' ) + ' Lot ' + (produit.num_lot or '') + ' Num ' + (produit.numero or '') + ' Sup : ' + str(produit.superficie)
